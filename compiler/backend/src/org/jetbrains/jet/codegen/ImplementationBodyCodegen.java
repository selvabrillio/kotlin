...
public class ImplementationBodyCodegen extends ClassBodyCodegen {
            ...
            functionCodegen.generateDefaultIfNeeded(
                    ...
                    new DefaultParameterValueLoader() {
                        ...
                        public void putValueOnStack(ValueParameterDescriptor valueParameter, ExpressionCodegen codegen) {
                            ...
                            codegen.intermediateValueForProperty(property, false, null, StackValue.none()).putNoReceiver(propertyType,
                                                                                                                         codegen.v);
                        }
                    },
                    null
    ...
    private int putClassObjectInLocalVar(ExpressionCodegen codegen) {
        ...
        if (classObjectIndex == -1) {
            ...
            StackValue.Local local = StackValue.local(classObjectIndex, classObject.type);
            ExpressionCodegen.genStore(local, classObject, codegen.v);
        }
    ...
    private void copyFieldFromClassObject(PropertyDescriptor propertyDescriptor) {
        ...
        ExpressionCodegen.genStore(field, property, codegen.v);
    }
    ...
    private void generatePrimaryConstructorImpl(
        ...
        if (isObject(descriptor)) {
            ExpressionCodegen.genStore(StackValue.singleton(descriptor, typeMapper), StackValue.local(0, classAsmType), iv);
        }
    ...
    private void genCallToDelegatorByExpressionSpecifier(
        ...
        if (fieldInfo.generateField) {
            ...
            ExpressionCodegen.genStore(fieldInfo.getStackValue(), rightSide, iv);
        }
    }
