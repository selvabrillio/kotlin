...
@InnerTestClasses({LazyResolveRecursiveComparingTestGenerated.CompiledKotlin.class, LazyResolveRecursiveComparingTestGenerated.CompiledKotlinCompilerOnly.class, LazyResolveRecursiveComparingTestGenerated.RecursiveComparator.class})
...
public class LazyResolveRecursiveComparingTestGenerated extends AbstractLazyResolveRecursiveComparingTest {
    ...
    @RunWith(JUnit3RunnerWithInners.class)
    public static class CompiledKotlinCompilerOnly extends AbstractLazyResolveRecursiveComparingTest {
        ...
        @TestDataPath("$PROJECT_ROOT")
        @InnerTestClasses({Annotations.DataClass.class, Annotations.Deprecated.class, Annotations.Inline.class})
        @RunWith(JUnit3RunnerWithInners.class)
        public static class Annotations extends AbstractLazyResolveRecursiveComparingTest {
            public void testAllFilesPresentInAnnotations() throws Exception {
            ...
            @TestMetadata("compiler/testData/loadJava/compiledKotlinCompilerOnly/annotations/dataClass")
            @TestDataPath("$PROJECT_ROOT")
            @RunWith(JUnit3RunnerWithInners.class)
            public static class DataClass extends AbstractLazyResolveRecursiveComparingTest {
                public void testAllFilesPresentInDataClass() throws Exception {
                    JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/loadJava/compiledKotlinCompilerOnly/annotations/dataClass"), Pattern.compile("^(.+)\\.kt$"), true);
                }

                @TestMetadata("MixedComponents.kt")
                public void testMixedComponents() throws Exception {
                    String fileName = JetTestUtils.navigationMetadata("compiler/testData/loadJava/compiledKotlinCompilerOnly/annotations/dataClass/MixedComponents.kt");
                    doTest(fileName);
                }

                @TestMetadata("NoComponents.kt")
                public void testNoComponents() throws Exception {
                    String fileName = JetTestUtils.navigationMetadata("compiler/testData/loadJava/compiledKotlinCompilerOnly/annotations/dataClass/NoComponents.kt");
                    doTest(fileName);
                }

                @TestMetadata("OneVal.kt")
                public void testOneVal() throws Exception {
                    String fileName = JetTestUtils.navigationMetadata("compiler/testData/loadJava/compiledKotlinCompilerOnly/annotations/dataClass/OneVal.kt");
                    doTest(fileName);
                }

                @TestMetadata("OpenDataClass.kt")
                public void testOpenDataClass() throws Exception {
                    String fileName = JetTestUtils.navigationMetadata("compiler/testData/loadJava/compiledKotlinCompilerOnly/annotations/dataClass/OpenDataClass.kt");
                    doTest(fileName);
                }

                @TestMetadata("OpenPropertyFinalComponent.kt")
                public void testOpenPropertyFinalComponent() throws Exception {
                    String fileName = JetTestUtils.navigationMetadata("compiler/testData/loadJava/compiledKotlinCompilerOnly/annotations/dataClass/OpenPropertyFinalComponent.kt");
                    doTest(fileName);
                }

                @TestMetadata("TwoVals.kt")
                public void testTwoVals() throws Exception {
                    String fileName = JetTestUtils.navigationMetadata("compiler/testData/loadJava/compiledKotlinCompilerOnly/annotations/dataClass/TwoVals.kt");
                    doTest(fileName);
                }

                @TestMetadata("TwoVars.kt")
                public void testTwoVars() throws Exception {
                    String fileName = JetTestUtils.navigationMetadata("compiler/testData/loadJava/compiledKotlinCompilerOnly/annotations/dataClass/TwoVars.kt");
                    doTest(fileName);
                }
            }
            ...
            @TestDataPath("$PROJECT_ROOT")
            @RunWith(JUnit3RunnerWithInners.class)
            public static class Deprecated extends AbstractLazyResolveRecursiveComparingTest {
