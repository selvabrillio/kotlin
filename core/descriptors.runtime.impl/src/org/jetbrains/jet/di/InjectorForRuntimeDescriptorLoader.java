...
public class InjectorForRuntimeDescriptorLoader {
    ...
    public InjectorForRuntimeDescriptorLoader(
        ...
        this.deserializationGlobalContextForJava = new DeserializationGlobalContextForJava(lockBasedStorageManager, moduleDescriptor, javaClassDataFinder, annotationDescriptorLoader, constantDescriptorLoader, lazyJavaPackageFragmentProvider);
        ...
        deserializedDescriptorResolver.setErrorReporter(runtimeErrorReporter);

        annotationDescriptorLoader.setErrorReporter(runtimeErrorReporter);
        annotationDescriptorLoader.setKotlinClassFinder(reflectKotlinClassFinder);
        annotationDescriptorLoader.setModule(moduleDescriptor);
        annotationDescriptorLoader.setStorage(descriptorLoadersStorage);

        descriptorLoadersStorage.setErrorReporter(runtimeErrorReporter);
        descriptorLoadersStorage.setModule(moduleDescriptor);

        constantDescriptorLoader.setErrorReporter(runtimeErrorReporter);
        constantDescriptorLoader.setKotlinClassFinder(reflectKotlinClassFinder);
