...
public object CreateBinaryOperationActionFactory: JetSingleIntentionActionFactory() {
    override fun createAction(diagnostic: Diagnostic): IntentionAction? {
        ...
        val returnType = when {
            inOperation -> TypeInfo.ByType(builtIns.getBooleanType(), Variance.INVARIANT).substitutionFree()
            comparisonOperation -> TypeInfo.ByType(builtIns.getIntType(), Variance.INVARIANT).substitutionFree()
