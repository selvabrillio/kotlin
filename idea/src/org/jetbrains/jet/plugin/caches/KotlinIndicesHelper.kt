...
//            try {
                index.get(fqnString, project, scope)
                        ...
                        .map { resolveSession.resolveToDescriptor(it) as CallableDescriptor }
//            }
//            catch(e: IllegalStateException) { // TODO: it's a temporary hack because resolveToDescriptor fails on some declarations
//                return listOf()
//            }
        }
        else {
